                        ...
                        <img
                          src={
                            tab === "education"
                              ...
                              : tab === "critical"
                              ? "https://images.unsplash.com/photo-1493612276216-ee3925520721?w=600&auto=format&fit=crop&q=80&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Y3JpdGljYWwlMjB0aGlua2luZ3xlbnwwfHwwfHx8MA%3D%3D"
                              : "https://images.unsplash.com/photo-1479920252409-6e3d8e8d4866?w=600&auto=format&fit=crop&q=80&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8c29tZXdvbmUlMjB3b3JraW5nJTIwaW4lMjBhJTIwY29tcHV0ZXJ8ZW58MHx8MHx8fDI%3D"
                          }
              ...
              >
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Link href="/contact" className="flex-1 min-w-[200px]">
                    <Button size="lg" className="w-full bg-white text-indigo-700 hover:bg-white/90 shadow-lg">
                      <Users className="mr-2 h-4 w-4" /> Partner With Us
                    </Button>
                  </Link>
                  <Link href="/resources" className="flex-1 min-w-[200px]">
                    <Button size="lg" className="w-full bg-white text-indigo-700 hover:bg-white/90 shadow-lg">
